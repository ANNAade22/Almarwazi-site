...
Users: Admin user(s) managed via Supabase Auth
Posts: id, title, slug, content, featured_image, excerpt, published_date, author_id, status
Courses: id, title, description, image, duration, details
Inquiries: id, name, email, message, date, status
